...
# Correct usage of Hasher
hashed_admin = stauth.Hasher(passwords=["admin123"]).generate()[0]
hashed_student = stauth.Hasher(passwords=["student123"]).generate()[0]
...
# Registration and reset sidebar logic
